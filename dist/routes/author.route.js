...
router.get("/", validate(searchAuthorValidation), (req, res) => controller.list(req, res));
router.post("/", authenticate, validate(createAuthorValidation), (req, res) => controller.create(req, res));
// 3. Member routes (dengan ID) - HARUS DI BAWAH
router.get("/:id", validate(getAuthorByIdValidation), (req, res) => controller.getById(req, res));
router.put("/:id", authenticate, validate(updateAuthorValidation), (req, res) => controller.update(req, res));
router.delete("/:id", authenticate, validate(getAuthorByIdValidation), (req, res) => controller.remove(req, res));
